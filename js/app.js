...
App = (function ()
{
    function App (opt)
    {
        ...
        this.opt.args = ((_55_18_=this.opt.args) != null ? _55_18_ : `app
    ...
    App.prototype["onWinResize"] = function (win)
    {}
    ...
    App.prototype["winForEvent"] = function (event)
    {
        ...
        if (!w)
        {
            ...
            var list = _k_.list(this.allWins())
            for (var _342_18_ = 0; _342_18_ < list.length; _342_18_++)
            {
                w = list[_342_18_]
    ...
    App.prototype["startWatcher"] = function ()
    {
        ...
        for (var _417_16_ = 0; _417_16_ < list.length; _417_16_++)
        {
            dir = list[_417_16_]
    ...
    App.prototype["stopWatcher"] = function ()
    {
        ...
        for (var _431_20_ = 0; _431_20_ < list.length; _431_20_++)
        {
            watcher = list[_431_20_]
            watcher.close()
        }
