...
Stash = (function ()
{
    ...
    Stash.prototype["save"] = function ()
    {
        ...
        try
        {
            ...
            _k_.dbg("kode/stash.kode", 96, 12, "text", text)
            return slash.writeText(this.file,text,function (p)
            {
                _k_.dbg("kode/stash.kode", 98, 16, null, 'stashSaved')
